...
abstract class AbstractRefreshingService {
     ...
     * ```
     * onAllRefreshables {
     *   refreshDrawPile(game.board.drawPile)
     *   refreshMiddleCards(game.board.middleCards)
     *   refreshPlayerOpenCards(p1, p1.openCards)
     *   refreshPlayerHiddenCards(p2, p2.hiddenCards)
     * }
     * ```
     *
     */
